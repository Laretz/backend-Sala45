...
export class RoomController {
  ...
  async getAll(req: Request, res: Response): Promise<void> {
    try {
      const getAllRoomsUseCase = RoomUseCaseFactory.createGetAllRoomsUseCase(
        this.prisma
      );
  ...
  async getById(req: Request, res: Response): Promise<void> {
    try {
      ...
      const getRoomUseCase = RoomUseCaseFactory.createGetRoomUseCase(
        this.prisma
      );
  ...
  async getMeetingsByDate(req: Request, res: Response): Promise<void> {
    try {
      ...
      const getRoomMeetingsUseCase =
        RoomUseCaseFactory.createGetRoomMeetingsUseCase(this.prisma);
  ...
  async getMeetings(req: Request, res: Response): Promise<void> {
    try {
      ...
      const getRoomMeetingsUseCase =
        MeetingUseCaseFactory.createGetRoomMeetingsUseCase(this.prisma);
      const meetings = await getRoomMeetingsUseCase.execute(roomId, queryDate);
