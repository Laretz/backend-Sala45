...
export class AuthController {
  ...
  async register(req: Request, res: Response): Promise<void> {
    try {
      ...
      const registerUserUseCase = AuthUseCaseFactory.createRegisterUserUseCase(this.prisma);
  ...
  async login(req: Request, res: Response): Promise<void> {
    try {
      ...
      const loginUserUseCase = AuthUseCaseFactory.createLoginUserUseCase(this.prisma);
  ...
  async getMe(req: Request, res: Response): Promise<void> {
    try {
      ...
      const getUserUseCase = AuthUseCaseFactory.createGetUserUseCase(this.prisma);
